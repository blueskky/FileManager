...
import com.whty.eschoolbag.filemanager.model.Item;
...
public class AlbumMediaLoader extends CursorLoader {
    ...
    public static CursorLoader newInstance(Context context, Album album, boolean capture,LoadType type) {
        String selection;
